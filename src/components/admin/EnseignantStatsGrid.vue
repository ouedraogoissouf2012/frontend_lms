  ...
  <div class="stats-detail-grid">
    <div class="stat-detail-card">
      ...
      <div class="stat-detail-content">
        <span class="stat-detail-value">{{ stats.total_classes }}</span>
    ...
    <div class="stat-detail-card">
      ...
      <div class="stat-detail-content">
        <span class="stat-detail-value">{{ stats.total_matieres }}</span>
    ...
    <div class="stat-detail-card">
      ...
      <div class="stat-detail-content">
        <span class="stat-detail-value">{{ stats.total_heures_effectuees }}h</span>
    ...
    <div class="stat-detail-card">
      ...
      <div class="stat-detail-content">
        <span class="stat-detail-value">{{ stats.total_heures_prevues }}h</span>
    ...
    <div class="stat-detail-card">
      ...
      <div class="stat-detail-content">
        <span class="stat-detail-value">{{ stats.taux_realisation_global.toFixed(1) }}%</span>
    ...
    <div class="stat-detail-card">
      ...
      <div class="stat-detail-content">
        <span class="stat-detail-value">{{ stats.nb_seances_effectuees }}/{{ stats.nb_seances_total }}</span>
