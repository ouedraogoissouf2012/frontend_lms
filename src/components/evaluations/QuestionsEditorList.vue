...
<script setup>
/**
 * Section « Questions QCM » de CreateQuestions (H1) : en-tête + bouton d'ajout,
 * liste de QuestionItemEditor et état vide. Relaie chaque action au parent en y
 * joignant l'index pour application sur le tableau `questions` du composable.
 */
import QuestionItemEditor from './QuestionItemEditor.vue'
